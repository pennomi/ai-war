"""2D Vector implementation from http://www.pygame.org/wiki/2DVectorClass.

Stylistic cleanups by Thane Brimhall.
"""
import operator
import math
...
class Vec2d(object):
    ...
    def interpolate_to(self, other, interpolate_range):
        return Vec2d(self.x + (other[0] - self.x) * interpolate_range,
                     self.y + (other[1] - self.y) * interpolate_range)
